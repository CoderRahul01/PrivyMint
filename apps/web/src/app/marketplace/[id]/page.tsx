...
export default function OfferingDetailPage() {
  ...
  const handleBuy = async (e: React.FormEvent) => {
    ...
    try {
      // Simulate Compact buyShares() circuit execution
            ...
            <form onSubmit={handleBuy} className="space-y-4 pt-4 border-t border-white/10">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    disabled={isBuying || offering.status !== 'active'}
                  />
              ...
              {buySuccess && (
                <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs flex items-center gap-2">
                  ...
                  <span>Transaction confirmed! Shares added to your private ZK witness holdings.</span>
                </div>
              )}
